...
namespace DataAccessLayer.Models
{
    public partial class PayrolLogOnlyContext
    {
        ...
        protected void OnModelCreatingGeneratedProcedures(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RemiderOutputNotifications>().HasNoKey().ToView(null);
            ...
            modelBuilder.Entity<GetEmployeeAllowancesPopupOutput>().HasNoKey().ToView(null);
            modelBuilder.Entity<GetEmployeeAllowancesMainScreenOutput>().HasNoKey().ToView(null);
            modelBuilder.Entity<GetEmployeeDeductionsMainScreenOutput>().HasNoKey().ToView(null);
    ...
    public partial class PayrolLogOnlyContextProcedures : IPayrolLogOnlyContextProcedures
    {
        ...
        //}
        #endregion
        #region example of using Ado
        //    public async Task<(int, Dictionary<string, object>)> ExecuteStoredProcedureAsync(
        ...
        //                    {
        //                        var parameter = command.CreateParameter();
        //                        parameter.ParameterName = $"@{outParam.Key}";
        //                        parameter.Direction = ParameterDirection.Output;
        //                        parameter.Size = 4000; // Assuming a default size, adjust as necessary
        //                        command.Parameters.Add(parameter);
        //                    }
        //                }
        ...
        //                        if (param.Direction == ParameterDirection.Output)
        //                        {
        //                            outputValues.Add(param.ParameterName.TrimStart('@'), param.Value);
        //                        }
        //                    }
        //                }
