...
namespace BusinessLogicLayer.Services.Approvals
{
    public interface IApprovalsService
    {
        ...
        Task<int> SaveOverTimeWorkEmployee(SaveOverTimeWorkEmployee saveOverTimeWorkEmployee);
        Task<int> UpdateOverTimeWorkEmployee(UpdateOverTimeWorkEmployee saveOverTimeWorkEmployee);
